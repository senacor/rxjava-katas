...
public class Kata2TransformingObservable {
    ...
    public void transformingObservable() throws Exception {
        Observable<String> observable = WikiService.WIKI_SERVICE.fetchArticle("Russland");
        observable.flatMap(WikiService.WIKI_SERVICE::parseMediaWikiText)
                .flatMap(p -> Observable.from(p.getParagraphs()))
